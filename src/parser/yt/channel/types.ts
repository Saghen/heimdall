...
import { BrowseEndpoint, Navigation, NavigationSome, UrlEndpoint, WatchEndpoint } from '../components/utility/navigation'
import { CommandMetadata, Renderer, Some } from '../core/internals'
import { GridVideo } from '../video/processors/grid'

export type FullChannel<SelectedTab extends ChannelTabName> = TwoColumnBrowseResults<
...
export type Channel = Renderer<'channel', {
  channelId: string,
  title: Some<Text>,
  thumbnail: Thumbnail,
